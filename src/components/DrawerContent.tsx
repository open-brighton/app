...
const DRAWER_HEADER_HEIGHT = 160;
  ...
  return (
    <View style={[styles.container, backgroundStyle, { paddingTop: insets.top }]}>
      <View
        style={[
          styles.drawerHeader,
          { backgroundColor: colors.background, borderBottomColor: colors.icon },
        ]}
      >
        <LottieAnimation
          autoPlay
          loop
          style={styles.drawerLottie}
        />
      </View>
      <View style={styles.contentWrapper}>
        ...
        >
          ...
          <Text style={[styles.label, { color: textColor }]}>Submit Feedback</Text>
        </TouchableOpacity>
      ...
      >
        ...
        >
          ...
          <Text style={[styles.label, { color: textColor }]}>Brighton Website</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.item}
        ...
        >
          ...
          <Text style={[styles.label, { color: textColor }]}>Terms & Conditions</Text>
        </TouchableOpacity>
      </View>
      </View>
    </View>
